 ...
 * status of a Post. It can be constructed either from a string or int and
 * is able to validate itself. An instance can then be converted back to
 * int or string.
 *
 * Class PostStatus
 * @package App\Classes
...
class PostStatus
{
    ...
    /**
     * there is a reason that I avoid using __toString()
     * as it operates outside of the stack in PHP
